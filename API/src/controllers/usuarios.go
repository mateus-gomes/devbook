...
//Para de seguir o perfil de um usuário
func PararDeSeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if seguidorID == usuarioID {
		respostas.Erro(w, http.StatusBadRequest, errors.New("Não é possível parar de seguir você mesmo"))
		return
	}
...
//Buscar usuários que seguem determinado usuário
